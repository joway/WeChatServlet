...
import com.jiaqu365.weixin.common.bean.WxJsapiSignature;
...
import com.jiaqu365.weixin.common.session.StandardSessionManager;
import com.jiaqu365.weixin.common.session.WxSessionManager;
import com.jiaqu365.weixin.common.util.RandomUtils;
import com.jiaqu365.weixin.common.util.StringUtils;
import com.jiaqu365.weixin.common.util.crypto.SHA1;
import com.jiaqu365.weixin.common.util.crypto.WxCryptUtil;
import com.jiaqu365.weixin.common.util.fs.FileUtils;
import com.jiaqu365.weixin.common.util.http.MediaDownloadRequestExecutor;
import com.jiaqu365.weixin.common.util.http.MediaUploadRequestExecutor;
import com.jiaqu365.weixin.common.util.http.RequestExecutor;
import com.jiaqu365.weixin.common.util.http.SimpleGetRequestExecutor;
import com.jiaqu365.weixin.common.util.http.SimplePostRequestExecutor;
import com.jiaqu365.weixin.common.util.http.URIUtil;
import com.jiaqu365.weixin.common.util.http.Utf8ResponseHandler;
import com.jiaqu365.weixin.common.util.json.GsonHelper;
import com.jiaqu365.weixin.common.util.json.WxGsonBuilder;
import com.jiaqu365.weixin.common.util.xml.XStreamInitializer;
import com.jiaqu365.weixin.mp.bean.WxMpMassNews;
import com.jiaqu365.weixin.mp.bean.WxMpMaterial;
import com.jiaqu365.weixin.mp.util.http.MaterialUploadRequestExecutor;
import com.jiaqu365.weixin.mp.util.http.MaterialVoiceAndImageDownloadRequestExecutor;
import com.jiaqu365.weixin.mp.util.json.WxMpGsonBuilder;
import com.jiaqu365.weixin.mp.bean.WxMpCustomMessage;
import com.jiaqu365.weixin.mp.bean.WxMpGroup;
import com.jiaqu365.weixin.mp.bean.WxMpMassGroupMessage;
import com.jiaqu365.weixin.mp.bean.WxMpMassOpenIdsMessage;
import com.jiaqu365.weixin.mp.bean.WxMpMassVideo;
import com.jiaqu365.weixin.mp.bean.WxMpMaterialArticleUpdate;
import com.jiaqu365.weixin.mp.bean.WxMpMaterialNews;
import com.jiaqu365.weixin.mp.bean.WxMpSemanticQuery;
import com.jiaqu365.weixin.mp.bean.WxMpTemplateMessage;
import com.jiaqu365.weixin.mp.bean.result.WxMpMassSendResult;
import com.jiaqu365.weixin.mp.bean.result.WxMpMassUploadResult;
import com.jiaqu365.weixin.mp.bean.result.WxMpMaterialCountResult;
import com.jiaqu365.weixin.mp.bean.result.WxMpMaterialFileBatchGetResult;
import com.jiaqu365.weixin.mp.bean.result.WxMpMaterialNewsBatchGetResult;
import com.jiaqu365.weixin.mp.bean.result.WxMpMaterialUploadResult;
import com.jiaqu365.weixin.mp.bean.result.WxMpMaterialVideoInfoResult;
import com.jiaqu365.weixin.mp.bean.result.WxMpOAuth2AccessToken;
import com.jiaqu365.weixin.mp.bean.result.WxMpPayCallback;
import com.jiaqu365.weixin.mp.bean.result.WxMpPayResult;
import com.jiaqu365.weixin.mp.bean.result.WxMpPrepayIdResult;
import com.jiaqu365.weixin.mp.bean.result.WxMpQrCodeTicket;
import com.jiaqu365.weixin.mp.bean.result.WxMpSemanticQueryResult;
import com.jiaqu365.weixin.mp.bean.result.WxMpUser;
import com.jiaqu365.weixin.mp.bean.result.WxMpUserCumulate;
import com.jiaqu365.weixin.mp.bean.result.WxMpUserList;
import com.jiaqu365.weixin.mp.bean.result.WxMpUserSummary;
import com.jiaqu365.weixin.mp.bean.result.WxRedpackResult;
import com.jiaqu365.weixin.mp.util.http.MaterialDeleteRequestExecutor;
import com.jiaqu365.weixin.mp.util.http.MaterialNewsInfoRequestExecutor;
import com.jiaqu365.weixin.mp.util.http.MaterialVideoInfoRequestExecutor;
import com.jiaqu365.weixin.mp.util.http.QrCodeRequestExecutor;
